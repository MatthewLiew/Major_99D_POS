...
public class TicketLineInfo implements SerializableWrite, SerializableRead, Serializable {
	...
	/* Edited By Matthew */
    public TicketLineInfo(String productid, String productname, double dMultiply, double dPrice) {
        Properties props = new Properties();
        props.setProperty("product.name", productname);
        init(productid, null, dMultiply, dPrice, null, props, 0.0, 0.0);
    }
    ...
    public void setRefundQty(Double qty) {            // Edited By Matthew
        refundQty = qty;
    }
    ...
    public void setOrderQty(Double qty) {             // Edited By Matthew
        orderQty = qty;
    }
